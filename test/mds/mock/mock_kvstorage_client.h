...
#ifndef DINGOFS_TEST_MDS_MOCK_MOCK_KVSTORAGE_CLIENT_H_
#define DINGOFS_TEST_MDS_MOCK_MOCK_KVSTORAGE_CLIENT_H_
...
class MockKVStorageClient : public dingofs::kvstorage::KVStorageClient {
 public:
...
#endif  // DINGOFS_TEST_MDS_MOCK_MOCK_KVSTORAGE_CLIENT_H_
