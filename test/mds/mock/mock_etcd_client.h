...
#ifndef DINGOFS_TEST_MDS_MOCK_MOCK_ETCD_CLIENT_H_
#define DINGOFS_TEST_MDS_MOCK_MOCK_ETCD_CLIENT_H_
...
class MockEtcdClientImpl : public dingofs::kvstorage::KVStorageClient {
 public:
...
#endif  // DINGOFS_TEST_MDS_MOCK_MOCK_ETCD_CLIENT_H_
