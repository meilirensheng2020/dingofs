...
TEST_F(TestTopoUpdater, test_UpdatePartitionTopo_case1) {
  ...
  std::list<::dingofs::mds::topology::Partition> partitionList;
...
TEST_F(TestTopoUpdater, test_UpdatePartitionTopo_case3) {
  ...
  ::dingofs::mds::topology::Partition partition;
