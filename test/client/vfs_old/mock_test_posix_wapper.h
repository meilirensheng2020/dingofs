...
#ifndef DINGOFS_TEST_CLIENT_MOCK_TEST_POSIX_WAPPER_H_
#define DINGOFS_TEST_CLIENT_MOCK_TEST_POSIX_WAPPER_H_
...
using dingofs::common::PosixWrapper;
...
#endif  // DINGOFS_TEST_CLIENT_MOCK_TEST_POSIX_WAPPER_H_
