...
#ifndef DINGOFS_TEST_CLIENT_MOCK_CLIENT_S3_CACHE_MANAGER_H_
#define DINGOFS_TEST_CLIENT_MOCK_CLIENT_S3_CACHE_MANAGER_H_
...
class MockFileCacheManager : public FileCacheManager {
 public:
  ...
  MOCK_METHOD4(Read, int(uint64_t inodeId, uint64_t offset, uint64_t length,
                         char* dataBuf));
  MOCK_METHOD2(Flush, DINGOFS_ERROR(bool force, bool toS3));
...
class MockChunkCacheManager : public ChunkCacheManager {
 public:
  ...
  MOCK_METHOD3(Flush, DINGOFS_ERROR(uint64_t inodeId, bool force, bool toS3));
...
class MockDataCache : public DataCache {
 public:
  ...
  MOCK_METHOD2(Flush, DINGOFS_ERROR(uint64_t inodeId, bool toS3));
...
#endif  // DINGOFS_TEST_CLIENT_MOCK_CLIENT_S3_CACHE_MANAGER_H_
