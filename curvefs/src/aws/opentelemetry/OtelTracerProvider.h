...
#ifndef SRC_AWS_S3_OPENTELEMETRY_OTEL_TRACER_PROVIDER_H_
#define SRC_AWS_S3_OPENTELEMETRY_OTEL_TRACER_PROVIDER_H_
...
using smithy::components::tracing::TracerProvider;

/**
 * A Open Telemetry Implementation of TracerProvider.
 */
class OtelTracerProvider final : public TracerProvider {
 public:
...
#endif  // SRC_AWS_S3_OPENTELEMETRY_OTEL_TRACER_PROVIDER_H_