...
#ifndef CURVEFS_SRC_METASERVER_SUPERPARTITION_ACCESS_LOG_H_
#define CURVEFS_SRC_METASERVER_SUPERPARTITION_ACCESS_LOG_H_
...
#endif  // CURVEFS_SRC_METASERVER_SUPERPARTITION_ACCESS_LOG_H_
