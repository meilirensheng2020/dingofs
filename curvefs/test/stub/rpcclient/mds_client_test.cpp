...
#include "curvefs/test/stub/rpcclient/mock_mds_base_client.h"
#include "curvefs/test/stub/rpcclient/mock_mds_service.h"
...
class MdsClientImplTest : public testing::Test {
 protected:
  void SetUp() override {
    ::curvefs::stub::common::MdsOption mdsopt;
...
TEST_F(MdsClientImplTest, test_GetMetaServerInfo) {
  // in
  curvefs::stub::common::EndPoint ep;
  butil::str2endpoint("127.0.0.1", 5000, &ep);
  curvefs::stub::common::PeerAddr addr(ep);
