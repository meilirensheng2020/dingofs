...
#include "curvefs/test/stub/rpcclient/mock_cli2_client.h"
...
class MetaCacheTest : public testing::Test {
 protected:
  void SetUp() override {
    ...
    curvefs::stub::common::PeerAddr pd1;
    pd1.Parse("10.182.26.2:9120:0");
    curvefs::stub::common::PeerAddr pd2;
    pd2.Parse("127.0.0.1:9120:0");

    curvefs::stub::common::CopysetPeerInfo<MetaserverID> peerinfo_1(1, pd1,
                                                                    pd2);
    metaServerList_.AddCopysetPeerInfo(peerinfo_1);

    pd1.addr_.port = 9121;
    pd2.addr_.port = 9121;
    curvefs::stub::common::CopysetPeerInfo<MetaserverID> peerinfo_2(2, pd1,
                                                                    pd2);
    metaServerList_.AddCopysetPeerInfo(peerinfo_2);

    pd1.addr_.port = 9122;
    pd2.addr_.port = 9122;
    curvefs::stub::common::CopysetPeerInfo<MetaserverID> peerinfo_3(3, pd1,
                                                                    pd2);
 ...
 protected:
  ...
  curvefs::stub::common::CopysetInfo<MetaserverID> metaServerList_;
...
TEST_F(MetaCacheTest, test_GetTarget) {
  ...
  curvefs::stub::common::PeerAddr pd;
