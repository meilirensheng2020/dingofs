...
#include "curvefs/src/stub/rpcclient/cli2_client.h"

#include <brpc/server.h>
#include <gtest/gtest.h>

#include "curvefs/proto/cli2.pb.h"
#include "curvefs/test/stub/rpcclient/mock_cli2_service.h"
...
class Cli2ClientImplTest : public testing::Test {
 protected:
  void SetUp() override {
    ...
    peerAddr_ = curvefs::stub::common::PeerAddr(ep);
 ...
 protected:
  ...
  curvefs::stub::common::PeerAddr peerAddr_;
