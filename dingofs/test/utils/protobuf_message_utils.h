...
#ifndef DINGOFS_TEST_UTILS_PROTOBUF_MESSAGE_UTILS_H_
#define DINGOFS_TEST_UTILS_PROTOBUF_MESSAGE_UTILS_H_
...
// dingofs.metaserver.Dentry)  // NOLINT NOTES: does not support bytes/group
inline std::unique_ptr<Message> GenerateAnDefaultInitializedMessage(
