...
class ScheduleMetricsTest : public testing::Test {
 public:
  ...
  ::dingofs::mds::topology::MetaServer GetMetaServer(int id) {
    return ::dingofs::mds::topology::MetaServer(id, "hostname", "token", id,
                                                "ip", 9000, "ip", 9000);
  }

  ::dingofs::mds::topology::Server GetServer(int id) {
    std::string hostName = "hostname" + std::to_string(id);
    return ::dingofs::mds::topology::Server(id, hostName, "", 0, "", 0, id, 1);
  }
...
TEST_F(ScheduleMetricsTest, test_add_rm_addOp) {
  ...
  ::dingofs::mds::topology::CopySetInfo addCsInfo(1, 1);
...
TEST_F(ScheduleMetricsTest, test_add_rm_rmOp) {
  ...
  ::dingofs::mds::topology::CopySetInfo rmCsInfo(1, 2);
...
TEST_F(ScheduleMetricsTest, test_add_rm_transferOp) {
  ...
  ::dingofs::mds::topology::CopySetInfo transCsInfo(1, 3);
...
TEST_F(ScheduleMetricsTest, test_add_rm_changeOp) {
  ...
  ::dingofs::mds::topology::CopySetInfo changeCsInfo(1, 4);
