...
#ifndef DINGOFS_SRC_METASERVER_COPYSET_COPYSET_NODE_MANAGER_H_
#define DINGOFS_SRC_METASERVER_COPYSET_COPYSET_NODE_MANAGER_H_
...
#endif  // DINGOFS_SRC_METASERVER_COPYSET_COPYSET_NODE_MANAGER_H_
