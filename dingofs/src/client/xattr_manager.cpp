...
DINGOFS_ERROR XattrManager::CalOneLayerSumInfo(InodeAttr* attr) {
...
DINGOFS_ERROR XattrManager::FastCalOneLayerSumInfo(InodeAttr* attr) {
...
DINGOFS_ERROR XattrManager::CalAllLayerSumInfo(InodeAttr* attr) {
  std::stack<uint64_t> iStack;
...
DINGOFS_ERROR XattrManager::FastCalAllLayerSumInfo(InodeAttr* attr) {
  std::stack<uint64_t> iStack;
  std::mutex stackMutex;
...
DINGOFS_ERROR XattrManager::GetXattr(const char* name, std::string* value,
...
DINGOFS_ERROR XattrManager::UpdateParentInodeXattr(uint64_t parentId,
                                                   const XAttr& xattr,
                                                   bool direction) {
  ...
  DINGOFS_ERROR ret = inodeManager_->GetInode(parentId, pInodeWrapper);
  if (ret != DINGOFS_ERROR::OK) {
...
DINGOFS_ERROR XattrManager::UpdateParentXattrAfterRename(
