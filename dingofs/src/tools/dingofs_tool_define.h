...
#ifndef DINGOFS_SRC_TOOLS_DINGOFS_TOOL_DEFINE_H_
#define DINGOFS_SRC_TOOLS_DINGOFS_TOOL_DEFINE_H_
...
/* command */
// programe name
const char kProgrameName[] = "dingofs_tool";
// version
...
// configure
const char kConfPathHelp[] = "[-confPath=/etc/dingofs/tools.conf]";
// kHelp
const char kHelpStr[] =
    "Usage: dingofs_tool [Command] [OPTIONS...]\n"
    "COMMANDS:\n"  // NOLINT
    "version:           show the version of dingofs_tool\n"
    ...
    "create-fs:         create fs\n"
    "umount-fs:         umount dingofs from local and cluster\n"
...
/* Metric */
const char kVersionUri[] = "/vars/dingo_version";
const char kStatusUri[] = "/vars/status";
const char kMdsStatusUri[] = "/vars/dingofs_mds_status";
...
const char kVersionKey[] = "dingo_version";
const char kMdsStatusKey[] = "dingofs_mds_status";
...
void SetFlagInfo(dingofs::utils::Configuration* conf,
                 google::CommandLineFlagInfo* info, const std::string& key,
                 FlagInfoT* flag);

/* update flags */
extern std::function<void(dingofs::utils::Configuration*,
...
#endif  // DINGOFS_SRC_TOOLS_DINGOFS_TOOL_DEFINE_H_
