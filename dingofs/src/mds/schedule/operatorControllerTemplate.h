...
#ifndef DINGOFS_SRC_MDS_SCHEDULE_OPERATORCONTROLLERTEMPLATE_H_
#define DINGOFS_SRC_MDS_SCHEDULE_OPERATORCONTROLLERTEMPLATE_H_
...
#endif  // DINGOFS_SRC_MDS_SCHEDULE_OPERATORCONTROLLERTEMPLATE_H_
