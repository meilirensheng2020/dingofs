.. DingoFS documentation master file, created by
   sphinx-quickstart on Wed Apr 23 14:54:10 2025.
   You can adapt this file completely to your liking, but it should at least
   contain the root `toctree` directive.

Welcome to DingoFS Docs!
==========================

Here you will learn about what DingoFS is, and how to install and deploy DingoFS to build an application according to your need.
