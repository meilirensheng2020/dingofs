...
For large features or major changes to codebase, please create **dingofs Improvement Proposal (DIP)**. See template from [DIP-0](https://github.com/dingodb/dingofs/issues)
...
There is a dedicated on [Mailing list](mailto:dingofs@zetyun.com). Please use it when asking questions.
...
| `#DIP`          | dingofs Improvement Proposal                                                                                                           | N/A                                                                                                                                               |
