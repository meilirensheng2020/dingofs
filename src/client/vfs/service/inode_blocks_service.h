...
#ifndef DINGOFS_SRC_CLIENT_VFS_INODE_BLOCKS_SERVICE_H_
#define DINGOFS_SRC_CLIENT_VFS_INODE_BLOCKS_SERVICE_H_
...
class InodeBlocksServiceImpl : public pb::client::InodeBlocksService {
 public:
  InodeBlocksServiceImpl() = default;

  ~InodeBlocksServiceImpl() override = default;
...
#endif  // DINGOFS_SRC_CLIENT_VFS_INODE_BLOCKS_SERVICE_H_