...
#ifndef DINGOFS_SRC_CLIENT_VFS_META_V2_ID_CACHE_H_
#define DINGOFS_SRC_CLIENT_VFS_META_V2_ID_CACHE_H_
...
class IdCache {
 public:
  IdCache(const std::string& name, MDSClientPtr mds_client,
...
#endif  // DINGOFS_SRC_CLIENT_VFS_META_V2_ID_CACHE_H_