...
#ifndef DINGOFS_SRC_CLIENT_KVCLIENT_MEMCACHE_CLIENT_H_
#define DINGOFS_SRC_CLIENT_KVCLIENT_MEMCACHE_CLIENT_H_
...
#endif  //  DINGOFS_SRC_CLIENT_KVCLIENT_MEMCACHE_CLIENT_H_
