...
#ifndef DINGOFS_SRC_CLIENT_BLOCKCACHE_DISK_CACHE_METRIC_H_
#define DINGOFS_SRC_CLIENT_BLOCKCACHE_DISK_CACHE_METRIC_H_
...
#endif  // DINGOFS_SRC_CLIENT_BLOCKCACHE_DISK_CACHE_METRIC_H_
