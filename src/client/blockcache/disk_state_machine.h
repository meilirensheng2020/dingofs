...
#ifndef DINGOFS_SRC_CLIENT_BLOCKCACHE_DISK_STATE_MACHINE_H_
#define DINGOFS_SRC_CLIENT_BLOCKCACHE_DISK_STATE_MACHINE_H_
...
#endif  // DINGOFS_SRC_CLIENT_BLOCKCACHE_DISK_STATE_MACHINE_H_
