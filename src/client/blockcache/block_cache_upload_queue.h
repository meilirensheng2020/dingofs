...
#ifndef DINGOFS_SRC_CLIENT_BLOCKCACHE_BLOCK_CACHE_UPLOADER_QUEUE_H_
#define DINGOFS_SRC_CLIENT_BLOCKCACHE_BLOCK_CACHE_UPLOADER_QUEUE_H_
...
#endif  // DINGOFS_SRC_CLIENT_BLOCKCACHE_BLOCK_CACHE_UPLOADER_QUEUE_H_
