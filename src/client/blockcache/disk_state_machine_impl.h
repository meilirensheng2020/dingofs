...
#ifndef DINGOFS_SRC_CLIENT_BLOCKCACHE_DISK_STATE_MACHINE_IMPL_H_
#define DINGOFS_SRC_CLIENT_BLOCKCACHE_DISK_STATE_MACHINE_IMPL_H_
...
#endif  // DINGOFS_SRC_CLIENT_BLOCKCACHE_DISK_STATE_MACHINE_IMPL_H_
