...
#ifndef DINGOFS_DATA_ACCESS_BLOCK_ACCESSER_FACTORY_H_
#define DINGOFS_DATA_ACCESS_BLOCK_ACCESSER_FACTORY_H_
...
#endif  // DINGOFS_DATA_ACCESS_BLOCK_ACCESSER_FACTORY_H_
