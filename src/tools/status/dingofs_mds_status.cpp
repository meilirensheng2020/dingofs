...
int MdsStatusTool::Init() {
  ...
  dingofs::utils::SplitString(FLAGS_mdsAddr, ",", &hostsMainAddr);
...
void MdsStatusTool::InitHostsAddr() {
  // use dummy addr
  dingofs::utils::SplitString(FLAGS_mdsDummyAddr, ",", &hostsAddr_);
}

void MdsStatusTool::AddUpdateFlags() {
  AddUpdateFlagsFunc(dingofs::tools::SetMdsAddr);
  AddUpdateFlagsFunc(dingofs::tools::SetMdsDummyAddr);
