 ...
 * Author: chengyi01
 */
#ifndef DINGOFS_SRC_TOOLS_STATUS_DINGOFS_MDS_STATUS_H_
#define DINGOFS_SRC_TOOLS_STATUS_DINGOFS_MDS_STATUS_H_
...
#endif  // DINGOFS_SRC_TOOLS_STATUS_DINGOFS_MDS_STATUS_H_
