...
DEFINE_string(confPath, "/etc/dingofs/tools.conf", "config file path of tools");
DEFINE_string(fsName, "dingofs", "fs name");
DEFINE_string(fsId, "1,2,3", "fs id");
DEFINE_string(mountpoint, "127.0.0.1:9000:/mnt/dingofs-umount-test",
              "dingofs mount in local path");
...
template <class FlagInfoT>
void SetDiffFlagInfo(dingofs::utils::Configuration* conf,
