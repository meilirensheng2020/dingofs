...
#ifndef DINGOFS_SRC_METRICS_CACHE_DISK_CACHE_GROUP_METRIC_H_
#define DINGOFS_SRC_METRICS_CACHE_DISK_CACHE_GROUP_METRIC_H_
...
#endif  // DINGOFS_SRC_METRICS_CACHE_DISK_CACHE_GROUP_METRIC_H_
