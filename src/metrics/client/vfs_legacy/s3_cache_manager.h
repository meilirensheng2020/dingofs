...
#ifndef DINGOFS_SRC_METRICS_CLIENT_VFS_LEGACY_S3_CACHE_MANAGER_H_
#define DINGOFS_SRC_METRICS_CLIENT_VFS_LEGACY_S3_CACHE_MANAGER_H_
...
struct S3MultiManagerMetric {
  inline static const std::string prefix = "dingofs_client_manager";
...
#endif  // DINGOFS_SRC_METRICS_CLIENT_VFS_LEGACY_S3_CACHE_MANAGER_H_
