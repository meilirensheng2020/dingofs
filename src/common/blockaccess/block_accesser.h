...
#ifndef DINGOFS_COMMON_BLOCK_ACCESS_BLOCK_ACCESSER_H_
#define DINGOFS_COMMON_BLOCK_ACCESS_BLOCK_ACCESSER_H_
...
#endif  // DINGOFS_COMMON_BLOCK_ACCESS_BLOCK_ACCESSER_H_
