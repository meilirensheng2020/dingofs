...
#ifndef DINGOFS_SRC_METASERVER_STORAGE_DUMPFILE_H_
#define DINGOFS_SRC_METASERVER_STORAGE_DUMPFILE_H_
 ...
 * v1:
 *   +---------+---------+------+-----------------+-----------+
 *   | DINGOFS | version | size | key_value_pairs | check_sum |
 *   +---------+---------+------+-----------------+-----------+
 *      DINGOFS:  "DINGOFS" (7-bytes)
 ...
 * v2:
 *   +---------+---------+-----------------+-----+-----------+
 *   | DINGOFS | version | key_value_pairs | EOF | check_sum |
 *   +---------+---------+-----------------+-----+-----------+
 *      DINGOFS:  "DINGOFS" (7-bytes)
 *      version:  uint8_t   (1-byte)
...
#endif  // DINGOFS_SRC_METASERVER_STORAGE_DUMPFILE_H_
