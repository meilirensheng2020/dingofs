...
#ifndef DINGOFS_SRC_METASERVER_STORAGE_ROCKSDB_EVENT_LISTENER_H_
#define DINGOFS_SRC_METASERVER_STORAGE_ROCKSDB_EVENT_LISTENER_H_
...
#endif  // DINGOFS_SRC_METASERVER_STORAGE_ROCKSDB_EVENT_LISTENER_H_
