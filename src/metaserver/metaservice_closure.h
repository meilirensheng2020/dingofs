...
#ifndef DINGOFS_SRC_METASERVER_METASERVICE_CLOSURE_H_
#define DINGOFS_SRC_METASERVER_METASERVICE_CLOSURE_H_
...
#endif  // DINGOFS_SRC_METASERVER_METASERVICE_CLOSURE_H_
