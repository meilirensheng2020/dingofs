...
#ifndef DINGOFS_SRC_METASERVER_COPYSET_META_OPERATOR_H_
#define DINGOFS_SRC_METASERVER_COPYSET_META_OPERATOR_H_
...
#endif  // DINGOFS_SRC_METASERVER_COPYSET_META_OPERATOR_H_
