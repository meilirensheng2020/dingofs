...
#ifndef DINGOFS_SRC_METASERVER_COPYSET_SNAPSHOT_CLOSURE_H_
#define DINGOFS_SRC_METASERVER_COPYSET_SNAPSHOT_CLOSURE_H_
...
#endif  // DINGOFS_SRC_METASERVER_COPYSET_SNAPSHOT_CLOSURE_H_
