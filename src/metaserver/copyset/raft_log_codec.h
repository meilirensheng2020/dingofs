...
#ifndef DINGOFS_SRC_METASERVER_COPYSET_RAFT_LOG_CODEC_H_
#define DINGOFS_SRC_METASERVER_COPYSET_RAFT_LOG_CODEC_H_
...
#endif  // DINGOFS_SRC_METASERVER_COPYSET_RAFT_LOG_CODEC_H_
