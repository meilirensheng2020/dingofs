...
#ifndef DINGOFS_SRC_METASERVER_COPYSET_OPERATOR_TYPE_H_
#define DINGOFS_SRC_METASERVER_COPYSET_OPERATOR_TYPE_H_
...
#endif  // DINGOFS_SRC_METASERVER_COPYSET_OPERATOR_TYPE_H_
