...
#ifndef DINGOFS_SRC_METASERVER_COPYSET_TRASH_H_
#define DINGOFS_SRC_METASERVER_COPYSET_TRASH_H_
...
class CopysetTrash {
 public:
  ...
  bool Init(const CopysetTrashOptions& options, dingofs::fs::LocalFileSystem* fs);
 ...
 private:
  ...
  dingofs::fs::LocalFileSystem* lfs_;
  std::string trashDir_;
  std::atomic<bool> running_;
  std::thread recycleThread_;
  dingofs::utils::InterruptibleSleeper sleeper_;
};
...
#endif  // DINGOFS_SRC_METASERVER_COPYSET_TRASH_H_
