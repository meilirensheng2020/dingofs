 ...
 * Author: wanghai01
 */
#ifndef DINGOFS_SRC_MDS_TOPOLOGY_TOPOLOGY_ID_GENERATOR_H_
#define DINGOFS_SRC_MDS_TOPOLOGY_TOPOLOGY_ID_GENERATOR_H_
...
#endif  // DINGOFS_SRC_MDS_TOPOLOGY_TOPOLOGY_ID_GENERATOR_H_
