...
#ifndef DINGOFS_SRC_MDS_SCHEDULE_SCHEDULEMETRICSTEMPLATE_H_
#define DINGOFS_SRC_MDS_SCHEDULE_SCHEDULEMETRICSTEMPLATE_H_
...
#endif  // DINGOFS_SRC_MDS_SCHEDULE_SCHEDULEMETRICSTEMPLATE_H_
