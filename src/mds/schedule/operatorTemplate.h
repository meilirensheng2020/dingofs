...
#ifndef DINGOFS_SRC_MDS_SCHEDULE_OPERATORTEMPLATE_H_
#define DINGOFS_SRC_MDS_SCHEDULE_OPERATORTEMPLATE_H_
...
#endif  // DINGOFS_SRC_MDS_SCHEDULE_OPERATORTEMPLATE_H_
