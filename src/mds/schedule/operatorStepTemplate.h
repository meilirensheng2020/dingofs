 ...
 * Author: lixiaocui
 */
#ifndef DINGOFS_SRC_MDS_SCHEDULE_OPERATORSTEPTEMPLATE_H_
#define DINGOFS_SRC_MDS_SCHEDULE_OPERATORSTEPTEMPLATE_H_
...
#endif  // DINGOFS_SRC_MDS_SCHEDULE_OPERATORSTEPTEMPLATE_H_
