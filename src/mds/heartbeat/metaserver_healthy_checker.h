...
#ifndef DINGOFS_SRC_MDS_HEARTBEAT_METASERVER_HEALTHY_CHECKER_H_
#define DINGOFS_SRC_MDS_HEARTBEAT_METASERVER_HEALTHY_CHECKER_H_
...
#endif  // DINGOFS_SRC_MDS_HEARTBEAT_METASERVER_HEALTHY_CHECKER_H_
