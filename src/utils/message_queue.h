...
#ifndef DINGOFS_SRC_UTILS_MESSAGE_QUEUE_H_
#define DINGOFS_SRC_UTILS_MESSAGE_QUEUE_H_
...
class MessageQueue {
 ...
 public:
  MessageQueue(const std::string& name, size_t bufferSize)
      : name_(name), running_(false), handler_(), queue_(bufferSize) {}
 ...
 private:
  ...
  utils::TaskQueue queue_;
};

}  // namespace utils
}  // namespace dingofs

#endif  // DINGOFS_SRC_UTILS_MESSAGE_QUEUE_H_
