...
#ifndef DINGOFS_SRC_CACHE_BLOCKCACHE_BLOCK_READER_H_
#define DINGOFS_SRC_CACHE_BLOCKCACHE_BLOCK_READER_H_
...
#endif  // DINGOFS_SRC_CACHE_BLOCKCACHE_BLOCK_READER_H_
