...
#ifndef DINGOFS_SRC_CACHE_IUTIL_TASK_EXECUTION_QUEUE_H_
#define DINGOFS_SRC_CACHE_IUTIL_TASK_EXECUTION_QUEUE_H_
...
class TaskExecutionQueue {
 public:
  ...
  TaskExecutionQueue() = default;
  virtual ~TaskExecutionQueue() = default;
