...
sourcefile= '/etc/dingofs/monitor/grafana/report/report.tex'
imagedir= '/etc/dingofs/monitor/grafana/report/images/'
pdfpath= '/etc/dingofs/monitor/grafana/report/report.pdf'
clustername = '【DINGO】xxxxxxxxx'
