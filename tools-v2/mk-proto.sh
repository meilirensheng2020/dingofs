...
### proto/cli2.proto
protoc --go_out=proto --proto_path=.. \
    --go_opt=Mproto/common.proto=github.com/dingodb/dingofs/tools-v2/proto/proto/common \
    ../proto/cli2.proto
### proto/common.proto
protoc --go_out=proto --proto_path=.. \
    ../proto/common.proto
...
protoc --go_out=proto --proto_path=.. \
    --go_opt=Mproto/common.proto=github.com/dingodb/dingofs/tools-v2/proto/proto/common \
    --go_opt=Mproto/scan.proto=github.com/dingodb/dingofs/tools-v2/proto/proto/scan \
    ../proto/heartbeat.proto
### proto/topology
protoc --go_out=proto --proto_path=.. \
    --go_opt=Mproto/common.proto=github.com/dingodb/dingofs/tools-v2/proto/proto/common \
...
protoc --go_out=proto --proto_path=.. \
    --go_opt=Mcurvefs/proto/common.proto=github.com/dingodb/dingofs/tools-v2/proto/curvefs/proto/common \
    ../curvefs/proto/cli2.proto
...
protoc --go_out=proto --proto_path=.. \
    --go_opt=Mcurvefs/proto/common.proto=github.com/dingodb/dingofs/tools-v2/proto/curvefs/proto/common \
    --go_opt=Mproto/heartbeat.proto=github.com/dingodb/dingofs/tools-v2/proto/proto/heartbeat \
    ../curvefs/proto/heartbeat.proto

### curvefs/proto/mds.proto
protoc --go_out=proto --proto_path=.. \
    --go_opt=Mcurvefs/proto/common.proto=github.com/dingodb/dingofs/tools-v2/proto/curvefs/proto/common \
    --go_opt=Mcurvefs/proto/topology.proto=github.com/dingodb/dingofs/tools-v2/proto/curvefs/proto/topology \
    ../curvefs/proto/mds.proto
...
protoc --go_out=proto --proto_path=.. \
    --go_opt=Mcurvefs/proto/common.proto=github.com/dingodb/dingofs/tools-v2/proto/curvefs/proto/common \
    --go_opt=Mcurvefs/proto/heartbeat.proto=github.com/dingodb/dingofs/tools-v2/proto/curvefs/proto/heartbeat \
    ../curvefs/proto/topology.proto
