...
const (
	...
	VIPER_CURVEBS_MDSADDR           = "dingobs.mdsAddr"
	CURVEBS_MDSDUMMYADDR            = "mdsdummyaddr"
	VIPER_CURVEBS_MDSDUMMYADDR      = "dingobs.mdsDummyAddr"
	CURVEBS_ETCDADDR                = "etcdaddr"
	VIPER_CURVEBS_ETCDADDR          = "dingobs.etcdAddr"
	CURVEBS_PATH                    = "path"
	VIPER_CURVEBS_PATH              = "dingobs.path"
	CURVEBS_DEFAULT_PATH            = "/test"
	CURVEBS_USER                    = "user"
	VIPER_CURVEBS_USER              = "dingobs.root.user"
	CURVEBS_DEFAULT_USER            = "root"
	CURVEBS_PASSWORD                = "password"
	VIPER_CURVEBS_PASSWORD          = "dingobs.root.password"
	CURVEBS_DEFAULT_PASSWORD        = "root_password"
	CURVEBS_CLUSTERMAP              = "clustermap"
	VIPER_CURVEBS_CLUSTERMAP        = "dingobs.clustermap"
	CURVEBS_FORCE                   = "force"
	VIPER_CURVEBS_FORCE             = "dingobs.force"
	CURVEBS_DEFAULT_FORCE           = false
	CURVEBS_LOGIC_POOL_ID           = "logicalpoolid"
	VIPER_CURVEBS_LOGIC_POOL_ID     = "dingobs.logicalpoolid"
	CURVEBS_COPYSET_ID              = "copysetid"
	VIPER_CURVEBS_COPYSET_ID        = "dingobs.copysetid"
	CURVEBS_PEERS_ADDRESS           = "peers"
	VIPER_CURVEBS_PEERS_ADDRESS     = "dingobs.peers"
	CURVEBS_OFFSET                  = "offset"
	VIPER_CURVEBS_OFFSET            = "dingobs.offset"
	CURVEBS_SIZE                    = "size"
	VIPER_CURVEBS_SIZE              = "dingobs.size"
	CURVEBS_DEFAULT_SIZE            = uint64(10)
	CURVEBS_TYPE                    = "type"
	VIPER_CURVEBS_TYPE              = "dingobs.type"
	CURVEBS_STRIPE_UNIT             = "stripeunit"
	VIPER_CURVEBS_STRIPE_UNIT       = "dingobs.stripeunit"
	CURVEBS_DEFAULT_STRIPE_UNIT     = "32 KiB"
	CURVEBS_STRIPE_COUNT            = "stripecount"
	VIPER_CURVEBS_STRIPE_COUNT      = "dingobs.stripecount"
	CURVEBS_DEFAULT_STRIPE_COUNT    = uint64(32)
	CURVEBS_RECYCLE_PREFIX          = "recycleprefix"
	VIPER_RECYCLE_PREFIX            = "dingobs.recycleprefix"
	CURVEBS_EXPIRED_TIME            = "expiredtime"
	VIPER_CURVEBS_EXPIRED_TIME      = "dingobs.expiredtime"
	CURVEBS_LIMIT                   = "limit"
	VIPER_CURVEBS_LIMIT             = "dingobs.limit"
	CURVEBS_BURST                   = "burst"
	VIPER_CURVEBS_BURST             = "dingobs.burst"
	CURVEBS_DEFAULT_BURST           = uint64(30000)
	CURVEBS_BURST_LENGTH            = "burstlength"
	VIPER_CURVEBS_BURST_LENGTH      = "dingobs.burstlength"
	CURVEBS_DEFAULT_BURST_LENGTH    = uint64(10)
	CURVEBS_OP                      = "op"
	VIPER_CURVEBS_OP                = "dingobs.op"
	CURVEBS_DEFAULT_OP              = "operator"
	CURVEBS_CHECK_TIME              = "checktime"
	VIPER_CURVEBS_CHECK_TIME        = "dingobs.checktime"
	CURVEBS_DEFAULT_CHECK_TIME      = 30 * time.Second
	CURVEBS_MARGIN                  = "margin"
	VIPER_CURVEBS_MARGIN            = "dingobs.margin"
	CURVEBS_DEFAULT_MARGIN          = uint64(1000)
	CURVEBS_SNAPSHOTADDR            = "snapshotaddr"
	VIPER_CURVEBS_SNAPSHOTADDR      = "dingobs.snapshotAddr"
	CURVEBS_SNAPSHOTDUMMYADDR       = "snapshotdummyaddr"
	VIPER_CURVEBS_SNAPSHOTDUMMYADDR = "dingobs.snapshotDummyAddr"
	CURVEBS_SCAN                    = "scan"
	VIPER_CURVEBS_SCAN              = "dingobs.scan"
	CURVEBS_DEFAULT_SCAN            = true
	CURVEBS_CHUNKSERVER_ID          = "chunkserverid"
	VIPER_CHUNKSERVER_ID            = "dingobs.chunkserverid"
	CURVEBS_DEFAULT_CHUNKSERVER_ID  = "*"
	CURVEBS_CHECK_CSALIVE           = "checkalive"
	VIPER_CURVEBS_CHECK_CSALIVE     = "dingobs.checkalive"
	CURVEBS_CHECK_HEALTH            = "checkhealth"
	VIPER_CURVEBS_CHECK_HEALTH      = "dingobs.checkHealth"
	CURVEBS_CS_OFFLINE              = "offline"
	VIPER_CURVEBS_CS_OFFLINE        = "dingobs.offline"
	CURVEBS_CS_UNHEALTHY            = "unhealthy"
	VIPER_CURVEBS_CS_UNHEALTHY      = "dingobs.unhealthy"
)
