...
import (
	...
	"github.com/dingodb/dingofs/tools-v2/pkg/cli/command/curvefs/status/etcd"
	"github.com/dingodb/dingofs/tools-v2/pkg/cli/command/curvefs/status/mds"
...
const (
	clusterExample = `$ dingo fs status cluster`
)
