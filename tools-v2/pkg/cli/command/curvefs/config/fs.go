...
import (
	...
	"github.com/dingodb/dingofs/tools-v2/pkg/cli/command/curvefs/quota"
...
func NewConfigFsQuotaCommand() *cobra.Command {
	fsQuotaCmd := &ConfigFsQuotaCommand{
		FinalCurveCmd: basecmd.FinalCurveCmd{
			...
			Example: `$ curve fs config fs --mdsaddr "10.20.61.2:6700,172.20.61.3:6700,10.20.61.4:6700" --fsid 1 --capacity 10 --inodes 1000
$ curve fs config fs --fsid 1 --capacity 10 --inodes 1000
$ curve fs config fs --fsname dingofs --capacity 10 --inodes 1000
`,
		},
	}
