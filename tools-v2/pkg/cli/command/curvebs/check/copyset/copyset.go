...
import (
	...
	status "github.com/dingodb/dingofs/tools-v2/pkg/cli/command/curvebs/status/copyset"
	fscopyset "github.com/dingodb/dingofs/tools-v2/pkg/cli/command/curvefs/check/copyset"
	...
	"github.com/dingodb/dingofs/tools-v2/proto/proto/heartbeat"
	"github.com/spf13/cobra"
)

const (
	copysetExample = `$ dingo bs check copyset --copysetid 1 --logicalpoolid 1`
)
...
func NewCheckCopysetCommand() *CopysetCommand {
	copysetCmd := &CopysetCommand{
		FinalCurveCmd: basecmd.FinalCurveCmd{
			Use:     "copyset",
			Short:   "check copysets health in dingobs",
